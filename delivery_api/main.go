...
import (
	...
	"github.com/carloshomar/fuudelivery/delivery-api/app/routes"
...
func sendMessageToClient(clientID int64, message []byte) error {
	...
	log.Printf("Enviando mensagem para client %d (%d bytes)", clientID, len(message))
	return nil
}
...
func startHTTPServer() *fiber.App {
	...
	app.Get("/health", func(c *fiber.Ctx) error {
		return c.JSON(fiber.Map{"status": "ok", "service": "delivery-api"})
	})
